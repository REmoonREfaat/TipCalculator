...
import com.example.tipcalculator.databinding.ItemSavedTipBinding
...
class TipSummaryAdapter (val onItemSelected:(item:TipCalculationSummaryItem) ->Unit)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TipSummaryViewHolder {
        ...
        val binding= DataBindingUtil.inflate<ItemSavedTipBinding>(
            inflater, R.layout.item_saved_tip,parent,false)
    ...
    inner class TipSummaryViewHolder(val binding: ItemSavedTipBinding) :
